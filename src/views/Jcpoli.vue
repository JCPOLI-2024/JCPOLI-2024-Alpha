<!-- Pagina da JCPOLI -  Pagina da aba "Home"  -->
<!-- Esse arquivo especificamente foi o primeiro arquivo do view da JCPOLI que eu testei apenas chamar os componentes -->
<!-- Por isso que é maior e cheio de partes do código comentada -->
<!-- E assim, ao inves de de manter todo o código com inumeras linhas, e fazendo a lógica condicional aqui  -->
<!-- Afim de manter uma melhor organização do código, decidi dividir em componentes -->
<!-- Dividindo correntamento o que é da primeira, segunda e terceira edição -->
<!-- Uma solução temporária até que adicione o banco de dados -->
<template>
  ...
  export default class JCPOLI extends Vue {
    ...
    // Tentativa de tirar os dados dessa pagina de código e puxar do storage, 
    // porém acaba bugando os palestrantes (eles não aparecem quando se entra na página pela 1º vez, só quando da refresh)
    // constructor(){
    //   super()
    //    this.speakersList = speakers_jcpoli1
    // }

    // Código implementado para resolver o problema citado acima
    //   constructor() {
    //     super()
    //     this.speakersList = [
    //       {
