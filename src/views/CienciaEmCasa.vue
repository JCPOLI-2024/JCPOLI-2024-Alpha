<template>
    <div>
      ...
      <Main>
        ...
        <div class="courses-list">
          <div v-for="(props, index) in filtered_ciencia_em_casa" :key="index">
  ...
  export default class ciencia_em_casa extends Vue {
    private all_palestras
    private filtered_palestras
  
    private title = 'Ciencia Em Casa'
    private description = 'Agenda dos Eventos'
